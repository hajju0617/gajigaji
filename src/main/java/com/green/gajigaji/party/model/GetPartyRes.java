...
public class GetPartyRes {
    ...
    @Schema(example = "1", description = "모임 분야")private String partyGenre;
    ...
    @Schema(example = "1980", description = "최소년도")private int partyMinAge;
    @Schema(example = "2000", description = "최대년도")private int partyMaxAge;
    ...
    @Schema(example = "사진 url용 주소", description = "모임 사진")private String partyPic;
